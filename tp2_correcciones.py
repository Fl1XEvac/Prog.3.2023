...
if pizzeria == "si":
    ...
    if ingredientes_vegetarianos == "pimento":
        print("La pizza elegida es vegetariana y contiene Salsa, Mozzarella y Pimento.")
    else:
        print("La pizza elegida es vegetariana y contiene Salsa, Mozarella y Tofu")
else:
    print("Eliga los ingredientes")
    ingredientes= input("Ingredientes: Peperoni, Jamon o Salmon (solo se puede elegir uno): ").lower()
    if ingredientes == "peperoni":
        print("La pizza elegida no es vegetariana y contiene: Salsa, Mozzarella y Peperoni")
    else: 
        if ingredientes == "jamon":
            print("La pizza elegida no es vegetariana y contiene: Salsa, Mozzarella y Jamon")
        else:
            if ingredientes == "salmon":
                print("La pizza elegida no es vegetariana  y contiene: Salsa, Mozzarella y Salmon")
...
distancia= (ano1 - ano2)
if distancia < 0:
    print("Ha ingresado un numero negativo, por favor, ingrese un numero positivo.")
else:
    if distancia > ano1:
...
if horas_trabajadas > jornada_minima:
    ...
    print(f"El total de horas extras son: {horas_totales}")
    salario_extra= (salario_por_hora + (jornada_minima * 1.1))
    salario_total= (salario_por_hora + salario_extra)
    print(f"Y el salario total por las horas extra son: {salario_total}")
else:
    salario_total= horas_trabajadas * salario_por_hora
    print(f"El salario se mantienen igual ya que no ha hecho horas extra y ha trabajado: {horas_trabajadas} y el salario por esas horas trabajadas seria: {salario_total}")
